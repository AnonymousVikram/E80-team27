...
public:
  ...
  void getOrientation(float ax, float ay, float az, float mx, float my,
                      float mz);
  ...
  std::string headers =
      "Accel X [mg],Accel Y [mg],Accel Z [mg],Mag X [Gauss],Mag Y [Gauss],Mag "
      "Z [Gauss],Roll [deg],Pitch [deg],Heading [deg]";
