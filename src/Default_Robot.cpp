...
const int waypoint_dimensions = 3;       // waypoints are set to have two pieces of information, x then y.
double waypoints [] = { 0, 0, 5, 10, 0, 5, 10, 0, 0, 10, 0, 5, 0, 0, 5, 0, 0, 0 };   // listed as x0,y0,x1,y1, ... etc.
...
void loop() {
  ...
  if ( currentTime-printer.lastExecutionTime > LOOP_PERIOD ) {
    ...
    printer.printValue(10,gyro.printRollPitchYaw());
    printer.printValue(11,gyro.printAccels());
    printer.printValue(12,gyro.printOrientation());
